...
[
    ...
    //--------------------------------------------------------------------------------------------------
    //
    // Genel Kullanımı: Ön tanımlı warning nesnesinin özelliklerini belirtmek için kullanılır.
    //
    //--------------------------------------------------------------------------------------------------
    'warning' =>
    [
        // Yönlendirmeyi Aktif Eder
        'redirect' => true,
        // Yönlendirme tipibi belirler siteurl ,baseurl
        'redirectType'=>'siteurl',
        // Varsayılan type
        'preType'=>'info',
        // Varsayılan yönlendirme linki
        'link'=>Config::get('Services','route')['show404'],
        // Varsayılan yönlendirme süresi
        'timer'=>0,
